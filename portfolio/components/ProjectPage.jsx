                ...
                <div className={styles.projectDescContainer}>
                    ...
                    <div className={styles.projectInfos}>
                        ...
                        <div className={styles.outsideLinks}>
                            ...
                            <a href={project.attributes.demo_url} className={`${styles.outsideLink} ${styles.lightUp}`} target="_blank" rel="noreferrer">Demo
                            ...
                            <a href={project.attributes.github_url} className={`${styles.outsideLink} ${styles.lightUp}`} target="_blank" rel="noreferrer">Github
                ...
                {project.attributes.image.data.map((image) => (
                    <div className={styles.imageContainer} key={image.id}>
                        {image.attributes.formats?.large &&
                            <Image
                            src={getStrapiMedia(image.attributes.formats.large)}
