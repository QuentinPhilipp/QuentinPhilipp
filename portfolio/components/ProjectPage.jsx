...
const ProjectPage = ({ project }) => {
  return (
        <div className={styles.projectLayout}>
            ...
            <RoughNotation strokeWidth="3" color="white" type="underline" show={true} className={styles.separatorTitle}>Preview:</RoughNotation>
